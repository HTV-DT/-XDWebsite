...
function Header() {
    return (
        <header className="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row bg-info">
            <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start bg-info" >
                <div className="me-3">
                    <button
            ...
            <div className="navbar-menu-wrapper d-flex align-items-top bg-info">
                <ul className="navbar-nav">
                    <li className="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <h1 className="welcome-text text-white">
                            Hệ thống, <span className="text-secondary fw-bold">Quản lý khách sạn</span>
                        </h1>
                        <h3 className="welcome-sub-text text-white">Luôn hỗ trợ giúp đỡ trong việc quản lý</h3>
                    </li>
                </ul>
                    ...
                    <li className="nav-item dropdown">
                        ...
                        >
                            ...
                            <Link className="dropdown-item preview-item">
                                <div className="preview-thumbnail">
                                    <img src="" alt="" className="img-sm profile-pic" />
                                </div>
                    ...
                    <li className="nav-item dropdown d-none d-lg-block user-dropdown">
                        ...
                        >
                            <div className="dropdown-header text-center">
                                <img className="img-md rounded-circle" src="" alt="" />
                            ...
                            <Link className="dropdown-item">
                                <i className="dropdown-item-icon mdi mdi-account-outline text-primary me-2" /> My
                                Profile <span className="badge badge-pill badge-danger">1</span>
                            </Link>
                            <Link className="dropdown-item">
